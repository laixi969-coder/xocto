...
它会去 Product Hunt、Hacker News、GitHub、Hugging Face 等公开源扫一遍，也会读取重点 AI 公司的官方更新；重复的自动跳过。
...
**已经能跑：**
- 六类免费公开源稳定采集：
  - **Product Hunt / Hacker News / GitHub / Hugging Face** —— 抓刚冒出来的东西，没数据，靠判断
  - **AICPB（AI 产品榜）** —— 抓已经跑出规模的，带真实访问量、月活和环比，含独立的中国榜
  - **AI 公司官方博客 / GitHub 官方 Release** —— 只作日报的行业背景，不会被当作一个新产品硬塞进产品池
