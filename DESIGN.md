...
| **长文正文** | **15px / 行高 1.85** | sans | 400 |
| 界面正文 | 16.5px / 行高 1.7 | sans | 400 |
| 元信息/标签 | 12.5-14.5px | sans | 400-600 |

中文正文比拉丁需要更大的字号：16.5px 是界面下限，长文（`.prose` / `.sec-body`）
一律 15px（x-octo 实际配置：阅读栏 740px，15px 行高 1.85 = 47-49 字/行；
2026-08-14 三次收紧：18px → 17px → 16px → 15px。DESIGN.md 默认 880px/18px
与站点 740px 容器错位，15px 是 x-octo 桌面长文实际阅读密度的稳定值）。
**15px 是中文 desktop longform 的下限**，再降 readability 损失。
...
| `.prose` | 整篇 Markdown（产品详情），15px/1.85 |
