...
| **长文正文** | **17px / 行高 1.85** | sans | 400 |
| 界面正文 | 16.5px / 行高 1.7 | sans | 400 |
| 元信息/标签 | 12.5-14.5px | sans | 400-600 |

中文正文比拉丁需要更大的字号：16.5px 是界面下限，长文（`.prose` / `.sec-body`）
一律 17px（x-octo 实际配置：阅读栏 740px，17px 行高 1.85 = 41-43 字/行；最初按 DESIGN 默认 880px 写成 18px，与站点实际 740px 错位，2026-08-14 修正）。
...
| `.prose` | 整篇 Markdown（产品详情），17px/1.85 |
