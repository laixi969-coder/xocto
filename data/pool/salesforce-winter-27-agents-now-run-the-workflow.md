---
slug: salesforce-winter-27-agents-now-run-the-workflow
name: Salesforce
builder: ''
category: ''
summary_zh: Salesforce Winter '27 是 Salesforce 平台的季节性更新，重点在于让 AI Agent 能够执行工作流，而不仅仅是提供建议。这改变了企业软件的使用方式，但
  Salesforce 本身是成熟产品，此次发布属于平台功能演进，而非独立新产品。
inspiration: ''
summary_en: Salesforce Winter '27 is a seasonal update to the Salesforce platform, focusing on enabling
  AI agents to execute workflows rather than just provide recommendations. This changes how enterprise
  software is used, but Salesforce itself is a mature product, and this release is a platform feature
  evolution, not an independent new product.
inspiration_en: ''
...
regions_en: []
open_source: false
url: https://news.google.com/rss/articles/CBMiiwFBVV95cUxNeE0xa0hnYmJucHJ4UHZjWDJwYWNtdnpjNXY1TndTZWtENVhkcmZ3WmVBV2w0UEtkLTM3bkpielR4WEg0WmNJcTE1YllKOVRZS18wek51NG1wSHdLOHF3S3lUc25XRS1JRGJsdXlPVDNOSVZwcjNpa0tBamZtak9pMDBDZmNTMTlwNXY4?oc=5
...
- source: newssearch
  ...
  kind: news
- source: newssearch
  url: https://news.google.com/rss/articles/CBMiYEFVX3lxTE9vdzBhZFlrSjVDY2lJSUV1dmZLOFJ0RFNBNHhYY3NMOUVNVmVuRDIwdVRHdHNxRVJoSHlULXFTRU1SeGFTYUhEZmRsOFUweDdmU1FMYXI2SzdEdDY3S2dPQw?oc=5
...
- source: newssearch
  ...
  kind: news
- source: newssearch
  url: https://news.google.com/rss/articles/CBMikwFBVV95cUxPd1NXZmhtUWN0Tk04TWFEaU5tUWt2Um9fZ21WbFk2bnptb2N3Mk5RemtMR014eVNiMUpDTlZBVDJ5a1VwWEVaWldWeW84RVpnNUtTUXJhWGpQOVU3Zy14Y0xQa25jUmdKSjNKcmJWdVRodHZFeDJfQ0dHYklNNG5oc3FnUWpWcDdHMzc5Mk9qbnFTNjg?oc=5
...
Salesforce Winter ’27: Agents Now Run the Workflow The Futurum Group
