...
builder: KieranHoward646
category: AI + 开发
summary_zh: 多AI协作的对抗性测试工作流，用于发现模型弱点。
inspiration: 把对抗性测试做成可复用技能，可迁移到任何需要验证AI鲁棒性的场景。
...
Multi-AI collaborative adversarial testing workflow
