...
builder: petergyang
category: AI + 开发
summary_zh: 像批注 Google 文档一样直接改 HTML 和 Markdown
inspiration: 把非技术人员挡在门外的是格式不是内容，做一层「所见即所得」就能打开新客群
summary_en: ''
inspiration_en: What keeps non-technical people out is the format, not the content. Add a see-what-you-get
  layer and a new customer base opens.
