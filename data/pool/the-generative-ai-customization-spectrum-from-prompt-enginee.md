---
slug: the-generative-ai-customization-spectrum-from-prompt-enginee
name: 'The generative AI customization spectrum: From prompt engineering to custom models on AWS'
builder: ''
category: ''
summary_zh: ''
inspiration: ''
...
summary: Pick the right generative AI customization approach on AWS with an 8-step decision framework,
  from prompt engineering and RAG to fine-tuning, continued pre-training, and Amazon Nova Forge. Start
