...
inspiration: ''
summary_en: On 21 September 2026, Grok 4.7 became available on AI Gateway alongside a 40% discount on
  AI Gateway, fx and eve. Model access and usage pricing dropped at the same time, meaning lower inference
  cost for developers adopting the model and a possible shift in competition at the multi-model routing
  and gateway layer.
inspiration_en: ''
