...
canonical_url: https://cartesia.ai
summary: Named to Madrona's 2026 Intelligent Applications 40 (Enabler stage). Wispr Flow is building the
...
Named to Madrona's 2026 Intelligent Applications 40 (Enabler stage). Wispr Flow is building the dictation layer, ElevenLabs spans text-to-speech, voice cloning, and agents, and Cartesia is powering real-time speech models under the hood, while HeyGen is doing the same work for video.
