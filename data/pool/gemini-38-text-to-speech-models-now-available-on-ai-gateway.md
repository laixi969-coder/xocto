...
inspiration: ''
summary_en: Google's Gemini 3.8 text-to-speech models became available on AI Gateway in September 2026,
  letting developers call the speech capability directly within an existing gateway. This makes speech
  synthesis a more readily consumable hosted model capability, lowering integration cost for voice-enabled
  applications and intensifying competition among speech model providers (inference).
inspiration_en: ''
