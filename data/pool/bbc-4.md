...
builder: pluc
category: ''
summary_zh: 2026年9月16日，微软公开表示竞争对手Anthropic的AI可能对人类造成“灾难性影响”。这是主要AI厂商之间围绕安全叙事与竞争定位的公开表态，意味着前沿模型厂商在安全议题上的相互施压可能影响企业客户对模型供应商的信任与采购选择；材料未提供任何产品、价格或采用数据，具体影响为推断。
inspiration: ''
summary_en: On 16 September 2026, Microsoft publicly said rival Anthropic's AI could have a 'disastrous
  impact' on humanity. This is a public positioning statement among major AI vendors around safety narratives
  and competition, implying that safety-based pressure between frontier model vendors may affect enterprise
  trust and vendor selection; the material provides no product, pricing or adoption data, so specific
  effects are inference.
inspiration_en: ''
