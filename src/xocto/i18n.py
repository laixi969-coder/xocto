...
ZH = Locale(
    ...
    t={
        ...
        "home": {
            ...
            "first_discoveries_empty": "今日首次发现将在本轮采集与真需求初判完成后出现。历史项目保留在机会库，不会被重新标记为今日新发现。",
            "update_kicker": "新增事实",
        ...
        "product": {
            "req_kicker": "真需求",
            "req_title": "真需求判断",
            "req_note": "依公开证据核验价值、采用、付费和交付；证据不足不等于需求不存在。",
            "req_signal": "初步结论",
            "req_level": "判断层级 / 日期",
            "req_next": "下一步核验",
            "req_initial": "初步判断",
...
EN = Locale(
    ...
    t={
        ...
        "home": {
            ...
            "first_discoveries_empty": "Today’s first discoveries appear after this collection and initial demand assessment finish. Historical projects remain in the opportunity library and are never relabelled as new today.",
