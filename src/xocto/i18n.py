...
ZH = Locale(
    ...
    t={
        ...
        "privacy": {
            ...
            "what_title": "会收集什么",
            "what_body": "启用后，我们会统计页面浏览、来源渠道、大致地区、设备类型、停留与滚动情况，以及产品页、每日判断和筛选功能的使用情况。Clarity 还会记录经默认隐私遮蔽处理的页面互动，用于查看点击与阅读体验。",
            "choice_title": "你的选择",
        ...
        "methodology": {
            ...
            "cadence_body": "每日从全球公开信息中收录新出现与已具规模的 AI 应用，来源涵盖平台、榜单与独立作者。仅保留能讲成生意的项目，采集渠道不对外公开。",
            "what_title": "我们记录什么",
            ...
            "evidence_body": "产品介绍来自公开资料，完整分析与每日判断属于编辑结论。引用具体结论时，请链接到对应的产品页或每日判断页，并保留页面显示的更新时间。",
            "takeaway_title": "生意判断是核心交付",
            "takeaway_body": "每个案例先回答：这是什么、是不是生意、谁付钱、从哪切、窗口在哪。打法库每个案例先看这是什么、能干什么，再看有什么可以参考。如实标注「还不是生意」或「未披露」，比貌似合理的猜测更有价值。",
            "updated": "最近数据更新",
        },
        "takeaways": {
            "title": "打法库",
            "lede": "每个案例先看这是什么、能干什么，再看有什么可以参考。",
            "desc": "{total} 个案例：这是什么、功能、可参考",
            "note": "来看案例，带走能用的参考，不是再逛一遍产品目录",
            "stat_cases": "案例",
            "what": "这是什么",
            "functions": "功能",
            "reference": "可参考",
        ...
        "home": {
            ...
            "fresh_picks_note": "最多三个：是什么、谁付钱、从哪切。",
            "daily_flow": "全球 AI+ 机会流",
            "flow_title": "最新一期全球 AI+ 新发现",
            "flow_kicker": "本期事件",
            "first_discoveries": "本期重点新发现",
            "first_discoveries_note": "从本期首次发现中挑选，兼顾类别覆盖；项目次日进入机会库。",
            "first_discoveries_empty": "本期新发现将在采集与初判完成后出现。历史项目保留在机会库，不会被重新包装成新发现。",
            "proven_kicker": "已具规模的生意",
            "proven_businesses": "已验证生意",
            "proven_businesses_note": "有公开规模或环比数据的成型产品。检验真需求是否成立、进入窗口是否仍在，非热度榜；每日轮换。",
            "event_proven": "已验证生意",
            "update_kicker": "新增事实",
            ...
            "market_summary_note": "具体变化、市场影响与可核验的来源。",
            "summary_source": "来源",
            ...
            "exit_k": "继续使用",
            "exit_title": "继续使用",
            "exit_note": "本期判断之外，这三处保留站上可直接取用的内容。",
            "exit_today": "本期完整判断",
            "exit_today_note": "判断背后的来龙去脉、边界与证据，三分钟读完。",
            "exit_cases": "已有收入的案例",
            "exit_cases_note": "按生意形态解读：谁付钱、窗口在哪、是否进入。",
            "exit_methods": "可参考的做法",
            "exit_methods_note": "这是什么、能干什么、有什么可以参考。",
            "more_opportunities": "值得继续研究的机会",
            "more_opportunities_note": "只收录仍在形成中的切口；按工作流与进入窗口排序，不按名气。",
            "replaces": "它替人省掉了哪一步",
            "takeaway": "可借鉴的做法",
            "direction": "趋势与切入",
            "notables": "还不是生意，但值得跟踪",
            "notables_note": "问题清楚，付费证据尚不足，先行记录",
            "movers": "规模出现变化",
            "movers_note": "公开使用数据出现异常变化。相关不等于因果，只说明值得追问",
            "today_takeaway_title": "本期可执行的做法",
            "today_takeaway_note": "一句可执行的做法，每日更新。",
            ...
            "latest_report": "本期判断",
            "daily_minutes": "一屏速览",
            "daily_contract": "每日更新；每个完成期次交付一条方向判断、三个证据案例和一个可执行动作。可先速览全页，需要时再深读。",
            "latest_report_note": "一句话看清本期方向",
            "latest_report_cta": "读完整判断",
            "fresh_kicker": "本期证据",
            "takeaway_kicker": "今天的动作",
            "past_kicker": "回看与校验",
            "past_reports": "往期判断",
            "past_reports_note": "往期判断长期保留，供对照后续证据，检验其是否成立。",
        ...
        "products": {
            ...
            "sort_recent": "最近出现",
            "sort_name": "名称",
            "no_summary": "暂无简介，需进一步调研才能判断",
            "money": "付费路径",
            "entry": "进入窗口",
            "empty": "当前筛选组合下暂无产品。",
            "reset": "清除筛选，显示全部 {total} 个",
            "show_more": "再显示 40 个",
        ...
        "product": {
            ...
            "story_adoption": "使用理由",
            "story_adoption_title": "为什么用户会选择它",
            ...
            "boards": "",
            "boards_note": "",
            "none_lead": "完整分析尚未完成，可先阅读上方的方向判断。",
        ...
        "report": {
            ...
            "archive_lede": "所有每日生意判断按日期永久归档，更早内容不会删除。",
            "archive_count": "已归档",
            "archive_empty": "暂无可回看的往期判断。",
        },
        "cases": {
            "kicker": "真实收入案例",
            "title": "真实案例拆解",
            "note": "从公开案例库选出的真实生意。数字标注证据等级：自报数字仅作线索，验证数字方可作事实。",
            "revenue": "月收入",
            "revenue_unit": " / 月",
            "startup_cost": "启动成本",
            "time_to_revenue": "到这一步用了",
            "source_link": "一手来源",
            "source_open": "查看原文",
            "verdict_k": "真需求判断",
            "money_k": "如何赚钱",
            "replaces_k": "它替代了什么旧行为",
            "first_customers_k": "首批用户来源",
            "channels_k": "获客渠道",
            "playbooks_k": "可借鉴的打法",
            "transfer_k": "迁移到 AI 生意",
            "boundary_k": "证据与边界",
            "gaps_k": "尚缺哪些证据",
            "revenue_note_k": "收入口径",
            "not_audited": "自报数字未经审计，仅作线索，不应视为事实",
            "verdict_labels": {"real": "真需求", "want": "想要非必需", "fake": "伪需求"},
            "evidence_levels": {
                "interviewed": "创始人采访自报",
                "stripe_verified": "Stripe 支付验证",
                "ai_estimated": "平台自动估算",
                "cited_public": "公开报道引用",
            },
            "home_kicker": "真实收入案例",
            "home_title": "谁在为它付钱",
            "home_note": "从公开案例库拆解的真实生意：如何赚钱、首批用户来源、打法能否迁移。每日轮换三条，数字标注证据等级。",
            "home_cta": "看完整拆解",
        },
    },
)
...
EN = Locale(
    ...
    heading_functions=("What it actually does",),
    ...
    t={
        ...
        "privacy": {
            ...
            "what_body": "After you enable analytics, we collect page views, traffic sources, approximate regions, device types, time and scroll engagement, and use of product pages, daily calls, and filters. Clarity also records privacy-masked page interactions to help us understand clicks and reading experience.",
        ...
        "methodology": {
            ...
            "evidence_body": "Product descriptions draw on public material; full analyses and daily calls are editorial judgments. When citing a conclusion, link to its product or daily-call page and keep the displayed update date.",
            "takeaway_title": "Business judgment is the core deliverable",
            "takeaway_body": "Every case answers: what it is, whether it is a business, who pays, where to enter, and what the window is. Playbook shows each case as what it is, what it does, and what is worth taking as reference. Honest 'not a business yet' or 'not disclosed' beats a polished guess.",
            "updated": "Latest data update",
        },
        "takeaways": {
            "title": "Playbook",
            "lede": "For each case: what it is, what it does, then what is worth taking as reference.",
            "desc": "{total} cases: what it is, what it does, what to take",
            "note": "Read the case, take the reference. Not another product catalog.",
            "stat_cases": "Cases",
            "what": "What it is",
            ...
            "site": "Site",
            "count_suffix": "cases",
            "empty": "No cases with a usable reference yet",
        },
        "home": {
            ...
            "keep_asking": "What to validate next",
            ...
            "first_discoveries": "Featured new discoveries",
            "first_discoveries_note": "Selected from this edition's first discoveries with category balance; entries move to the library the next day.",
            ...
            "market_summary_note": "Concrete changes, market implications, and traceable sources.",
            ...
            "exit_methods": "What to take from a case",
            "exit_methods_note": "What it is, what it does, and what is worth taking as reference.",
            ...
            "today_takeaway_note": "One usable move, updated daily.",
            ...
            "daily_contract": "Updated daily; each completed edition delivers one directional call, three evidence-backed cases, and one usable move. Skim the page first, then go deeper when needed.",
            ...
            "past_reports": "Past calls",
            "past_reports_note": "Past calls stay archived; check them against later evidence to see whether they held.",
        ...
        "product": {
            ...
            "story_scene": "Use case",
            "story_call": "xOcto's call",
            "story_adoption": "Reason to use it",
            "story_adoption_title": "Why users would choose it",
        ...
        "report": {
            ...
            "archive_empty": "No past calls to revisit yet.",
        },
        "cases": {
            "kicker": "Real-revenue cases",
            "title": "Real-business breakdown",
            "note": "Real businesses pulled from public case libraries. Every number carries its evidence level: self-reported is a lead, verified is a fact.",
            "revenue": "Monthly revenue",
            "revenue_unit": " / mo",
            "startup_cost": "Startup cost",
            "time_to_revenue": "Time to get here",
            "source_link": "Primary source",
            "source_open": "View original",
            "verdict_k": "Real-demand verdict",
            "money_k": "How it makes money",
            "replaces_k": "What old behavior it replaces",
            "first_customers_k": "Where the first customers came from",
            "channels_k": "Acquisition channels",
            "playbooks_k": "Tactics you can copy",
            "transfer_k": "Moving it to an AI business",
            "boundary_k": "Evidence and limits",
            "gaps_k": "What evidence is missing",
            "revenue_note_k": "Revenue basis",
            "not_audited": "Self-reported numbers are unaudited — treat them as leads, not facts",
            "verdict_labels": {"real": "Real demand", "want": "Nice-to-have", "fake": "Fake demand"},
            "evidence_levels": {
                "interviewed": "Founder interview, self-reported",
                "stripe_verified": "Stripe-verified",
                "ai_estimated": "Platform auto-estimate",
                "cited_public": "Cited from public reporting",
            },
            "home_kicker": "Real-revenue case",
            "home_title": "Who's actually paying",
            "home_note": "Real businesses broken down from public sources: how the money comes in, where the first users came from, whether the tactics transfer. Three a day, every number carries its evidence level.",
            "home_cta": "Read the breakdown",
        },
    },
)
