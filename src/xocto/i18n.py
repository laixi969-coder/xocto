...
ZH = Locale(
    ...
    t={
        ...
        "home": {
            ...
            "proven_businesses_note": "有公开规模或环比的成型产品。看真需求成不成立、窗口还在不在，不是热度榜。每天轮换一批。",
            "event_proven": "已验证生意",
            "update_kicker": "新增事实",
...
EN = Locale(
    ...
    t={
        ...
        "home": {
            ...
            "proven_businesses_note": "Formed products with public scale or month-on-month change. Read whether demand holds and whether the window is still open — not a heat ranking. A different batch is featured each day.",
