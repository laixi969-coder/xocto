...
ZH = Locale(
    ...
    t={
        ...
        "methodology": {
            ...
            "reader_title": "先按你的问题读",
            "reader_body": "创业者先看「进入窗口」和「可以借走什么」；投资者先看「商业模式」与「接下来验证什么」；研究者追完整证据；对 AI 好奇的读者先看它替代了什么旧行为。所有人读同一份事实，但不用从同一处开始。",
        ...
        "home": {
            "eyebrow": "AI 应用商业模式 · 每日",
            "lede_title": "今天这些 AI 应用，哪几个是真生意。",
            "lede_body": "每天自动更新。写给要决定下一步押什么的人。路过的人也能看懂今天发生了什么。一句判断、几个讲得清谁付钱的案例、一句能抄的做法。不给买卖建议。",
            "stat_total": "已收录",
            "what": "这是什么",
            "money": "怎么赚钱",
            "meaning": "从哪切进去",
            ...
            "routes_kicker": "从你的问题开始",
            "routes_title": "你现在要做哪一种判断？",
            "routes_note": "先选任务，再看产品；不要从一张长清单开始。",
            "route_founder": "我是创业者",
            "route_founder_note": "找正在被验证的付费问题、切入方式和可复用打法。",
            "route_investor": "我是投资者",
            "route_investor_note": "先看需求是否已成形、规模是否能转成收入、风险在哪里。",
            "route_curious": "我想看懂 AI",
            "route_curious_note": "用一个具体产品理解 AI 会先改掉什么工作和生活习惯。",
            "exit_k": "接着用",
            "exit_title": "接着用",
            ...
            "long_term_picks": "已经成势的",
            "long_term_picks_note": "行业已经怎么收钱。这是背景，不是今天的新闻。",
            "replaces": "它替人省掉了哪一步",
            "takeaway": "可借鉴的做法",
            "direction": "趋势与切入",
            ...
            "past_reports": "这几天的判断",
            "past_reports_note": "每天一句。回来能看见判断有没有被后来的事打脸。",
        ...
        "product": {
            ...
            "roles_kicker": "换一个身份再看",
            "roles_title": "同一案例，对不同人意味着不同的下一步",
            "for_founder_k": "如果你在创业",
            "for_investor_k": "窗口与风险",
            "for_public_k": "跟你有没有关系",
            "for_investor": {
...
EN = Locale(
    ...
    t={
        ...
        "methodology": {
            ...
            "reader_title": "Start with your question",
            "reader_body": "Builders start with the entry window and what to borrow; investors with the business model and what to validate next; researchers follow the evidence; AI-curious readers start with the old behavior being replaced. Everyone reads the same facts, but nobody has to start in the same place.",
        ...
        "home": {
            "eyebrow": "AI BUSINESS MODELS · DAILY",
            "lede_title": "Which of today's AI products are real businesses.",
            "lede_body": "Updated every day. Written for people deciding what to bet on next. Passers-by can still see what happened today. One call, a few cases that show who pays, one move you can copy. Not investment advice.",
            "stat_total": "Tracked",
            "what": "What it is",
            ...
            "routes_kicker": "Start with your question",
            "routes_title": "What decision are you here to make?",
            "routes_note": "Choose a task before a product. A long list is not a starting point.",
            "route_founder": "I'm building",
            "route_founder_note": "Find paying problems, a credible wedge, and moves worth adapting.",
            "route_investor": "I'm investing",
            "route_investor_note": "Test whether demand has formed, whether scale becomes revenue, and where risk sits.",
            "route_curious": "I want to understand AI",
            "route_curious_note": "Use a concrete product to see which work and habits AI may change first.",
            ...
            "long_term_picks": "Already at scale",
            "long_term_picks_note": "How the industry already charges. Context, not today's news.",
            ...
            "past_reports_note": "One call a day. Come back to see which ones later events overturned.",
        ...
        "product": {
            ...
            "roles_kicker": "Change the lens",
            "roles_title": "One case creates a different next move for each reader",
            "for_founder_k": "If you're building",
            "for_investor_k": "Window and risk",
            "for_public_k": "Does it touch you",
            "for_investor": {
