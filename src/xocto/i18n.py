...
ZH = Locale(
    ...
    t={
        ...
        "cases": {
            "kicker": "真实收入案例",
            "title": "真实案例拆解",
            "note": "从公开案例库挑出值得拆的真实生意。数字带证据等级：自报的当线索，验证的才当事实。",
            "revenue": "月收入",
            "revenue_unit": " / 月",
            "startup_cost": "启动成本",
            ...
            "gaps_k": "还缺什么证据",
            "revenue_note_k": "收入口径",
            "not_audited": "自报数字未经审计，当线索用，别当事实抄",
            ...
            "home_kicker": "真实收入案例",
            "home_title": "谁在为它付钱",
            "home_note": "从公开案例库拆出来的真实生意：靠什么赚钱、第一批用户从哪来、打法能不能抄。每天轮换三条，数字带证据等级。",
            "home_cta": "看完整拆解",
        },
    },
)
