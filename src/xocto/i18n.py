...
ZH = Locale(
    ...
    t={
        ...
        "methodology": {
            ...
            "decision_body": "每份案例先给 60 秒判断：结论、商业模式、进入窗口、待验证点；后面才是替代行为、数据、反例和完整推理。这样先帮助读者决定是否投入注意力，再允许他追查我们为什么这么判断。",
        ...
        "home": {
            ...
            "lede_body": "每天自动更新，覆盖中文与英文生态。记录新项目、开源采用、实质性 AI 改造与跨国机会，并以公开证据和 `/req` 初判说明其需求与待验证边界。",
            "stat_total": "已收录",
            "what": "这是什么",
            "dimensions": "机会维度",
            "money": "怎么赚钱",
            ...
            "flow_title": "今日全球 AI+ 新发现",
            "flow_kicker": "今日事件",
            "first_discoveries": "今日首次发现",
            "first_discoveries_note": "按 xOcto 首次发现时间倒序。项目次日进入机会库，不重复出现在这里。",
            "first_discoveries_empty": "今日首次发现将在本轮采集与 `/req` 初判完成后出现。历史项目保留在机会库，不会被重新标记为今日新发现。",
            "update_kicker": "新增事实",
            "important_updates": "重要更新",
            "important_updates_note": "仅保留新增事实会改变产品、市场或需求判断的项目。",
            "market_kicker": "当日变化",
            "market_summary": "当日市场摘要",
            "market_summary_note": "只归纳今日事件流中的行业与跨国差异，不以热度代替市场结论。",
            "market_industry": "今日首次发现涉及的行业",
            "market_industry_text": "今日首次发现项目涉及：{industries}。",
            "market_cross": "跨国供给差异",
            "market_cross_text": "已形成带覆盖范围的跨国机会判断：{products}。",
            "event_signal": "事件信号",
            "req_initial": "/req 初步判断",
            ...
            "signal_release": "新发布",
            "signal_update": "新增事实",
            "signal_open_source": "开源信号",
            "signal_adoption": "采用信号",
            "exit_k": "接着用",
            "exit_title": "接着用",
            ...
            "latest_report": "今日判断",
            "daily_minutes": "一屏先看完",
            "daily_contract": "每天一条方向判断、三个证据案例、一个能带走的动作。先扫一屏；需要时再深读，明天有新的。",
        ...
        "products": {
            ...
            "desc": "{total} 个 AI 生意案例：看需求、付费路径、进入窗口与待验证的风险。",
            "count": "当前结果",
            "results_jump": "查看结果 →",
            "f_category": "用户与场景",
            "f_type": "项目类型",
        ...
        "product": {
            "req_title": "/req 需求判断",
            "req_note": "按照价值、共识、模式、求真四道闸门记录；证据不足不等于否定需求。",
            "req_signal": "初步结论",
            "req_level": "判断层级 / 日期",
            "req_next": "下一项验证",
            "req_initial": "初步判断",
            "req_full": "完整判断",
            "req_pending": "尚未完成 `/req` 初判；公开证据到位后将补充四道闸门与下一项验证。",
            "req_value": "价值",
            "req_consensus": "共识",
            "req_model": "模式",
            "req_truth": "求真",
            ...
            "decision_note": "结论与证据分开：前四项帮助你做下一步选择，全文保留判断依据与反例。",
            "call": "一句判断",
            "watch_next": "接下来验证什么",
...
EN = Locale(
    ...
    t={
        ...
        "methodology": {
            ...
            "decision_body": "Every case begins with a 60-second read: the call, business model, entry window, and open validation. Only then come the old behavior, data, counterevidence, and full reasoning. It lets readers decide whether to spend attention before asking why we made the call.",
        ...
        "home": {
            ...
            "lede_body": "Updated every day across Chinese and English ecosystems. It records new projects, open-source adoption, material AI transformations, and cross-market opportunities, with public evidence and an initial `/req` review of demand and open questions.",
            "stat_total": "Tracked",
            "what": "What it is",
            ...
            "flow_title": "Today's new global AI+ discoveries",
            "flow_kicker": "Today's events",
            "first_discoveries": "First discovered today",
            "first_discoveries_note": "Newest xOcto discoveries first. Entries move to the library the next day.",
            "first_discoveries_empty": "Today’s first discoveries appear after this collection and initial `/req` review finish. Historical projects remain in the opportunity library and are never relabelled as new today.",
            ...
            "market_kicker": "Daily change",
            "market_summary": "Daily market summary",
            "market_summary_note": "It summarizes industries and cross-market differences in today’s event flow; popularity is not a market conclusion.",
            "market_industry": "Industries in today’s first discoveries",
            "market_industry_text": "Today’s first discoveries involve: {industries}.",
            ...
            "event_req": "/req change",
            "signal_release": "New release",
            "signal_update": "New evidence",
            "signal_open_source": "Open-source signal",
            "signal_adoption": "Adoption signal",
            ...
            "latest_report": "Today's call",
            "daily_minutes": "Start with one screen",
            "daily_contract": "One directional call, three evidence-backed cases, and one usable move every day. Scan one screen first; go deeper when needed, then return to a new edition tomorrow.",
            "latest_report_note": "One sentence on where this is heading",
            "latest_report_cta": "Read the full call",
            "fresh_kicker": "Today's evidence",
        ...
        "products": {
            ...
            "desc": "{total} AI business cases: demand, payment path, entry window, and the risk still to be tested.",
            "count": "Showing",
            ...
            "f_req": "Initial /req",
            "f_req_aria": "Filter by initial /req review",
        ...
        "product": {
            "req_title": "/req demand review",
            "req_note": "Value, consensus, model, and truth are recorded separately; limited evidence is not a denial of demand.",
            "req_signal": "Initial conclusion",
            "req_level": "Review level / date",
            "req_next": "Next validation",
            "req_initial": "Initial review",
            "req_full": "Full review",
            "req_pending": "The initial `/req` review is pending. The four gates and next validation will appear once public evidence is sufficient.",
            "req_value": "Value",
            ...
            "demand_unknown": "Needs validation",
            ...
            "decision_note": "Keep the call separate from its evidence: these four prompts guide your next move; the full read keeps the reasoning and counterevidence.",
            "call": "The call",
