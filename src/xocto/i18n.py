...
ZH = Locale(
    ...
    t={
        ...
        "methodology": {
            ...
            "takeaway_body": "每个案例先回答：这是什么、是不是生意、谁付钱、从哪切、窗口在哪。可借鉴的做法按产品逻辑、话术、定价结构放在「方法」。如实标注「还不是生意」或「未披露」，比貌似合理的猜测更有价值。",
            "updated": "最近数据更新",
        },
        "takeaways": {
            "title": "方法",
            "lede": "从案例中提炼的可迁移方法，按产品逻辑、话术、定价结构分类，供创业者回来取用打法。",
            "desc": "{total} 条生意方法，按产品逻辑 / 话术 / 定价结构分类",
            "note": "给创业者的方法，不是产品目录",
            "topic_product": "产品逻辑",
            "topic_product_note": "怎么做产品：可迁移的方法论",
            "topic_narrative": "话术",
            "topic_narrative_note": "怎么表达：可借鉴的文案结构",
            "topic_pricing": "定价结构",
            "topic_pricing_note": "怎么变现：可复用的定价策略",
            "count_suffix": "条",
            "empty": "暂无可借鉴条目",
        },
        "home": {
            ...
            "exit_methods": "可迁移的做法",
            "exit_methods_note": "产品怎么做、话怎么说、钱怎么收，可直接取用。",
