...
ZH = Locale(
    ...
    t={
        ...
        "home": {
            ...
            "market_summary_note": "收录今日产品之外的正式市场背景、行业变化与跨国差异，不以热度代替市场结论。",
...
EN = Locale(
    ...
    t={
        ...
        "home": {
            ...
            "market_summary_note": "It includes formal market context beyond products, industry shifts, and cross-market differences; popularity is not a market conclusion.",
